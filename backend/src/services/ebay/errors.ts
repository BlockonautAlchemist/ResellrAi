...
export const EBAY_ERROR_CODES = {
  ...
  VALIDATION_CONDITION_INVALID_FOR_CATEGORY: 'VALIDATION_CONDITION_INVALID_FOR_CATEGORY',
...
export const EBAY_ERROR_MESSAGES: Record<EbayErrorCode, string> = {
  ...
  VALIDATION_CONDITION_INVALID_FOR_CATEGORY: 'The selected condition is not valid for this category',
...
const RECOVERY_ACTIONS: Record<EbayErrorCode, EbayErrorRecoveryAction> = {
  ...
  VALIDATION_CONDITION_INVALID_FOR_CATEGORY: 'none',
